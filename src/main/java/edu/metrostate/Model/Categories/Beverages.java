...
public class Beverages extends Ingredient {

    public Beverages(int id, String name, Date expiryDate, NutritionalChart nutrition, MacroNutrient primaryMacroNutrient, Storage storage) {
